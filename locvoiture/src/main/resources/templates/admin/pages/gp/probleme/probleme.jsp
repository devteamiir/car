	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Gestion des Client <small>Admin</small>
				</h1>
				<ol class="breadcrumb">
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
	                 	...
	                 	<tr>
	        				<td>  <c:out value = "${variable.nomProb}"/></td>
	        				<td>  <c:out value = "${variable.descProb}"/></td>
	        				<td><a href="ProblemeController?action=modifier&id=<c:out value="${variable.idProb}"/>">Modifier</a><br>
                   				<a href="ProblemeController?action=supprimer&id=<c:out value="${variable.idProb}"/>">Supprimer</a></td>
	        			</tr>
	      				</c:forEach>
      ...
      <div class="register-logo">
        <a href="../../index2.html"><b>Nouveau</b>Problème</a>
      </div>

      <div class="register-box-body">
        <p class="login-box-msg">Entrez un nouveau probleme</p>
        <form action="<%= request.getContextPath() %>/ProblemeController?action=ajouter" method="post" >
          ...
          <div class="box-body pad">
                    ...
                    <textarea class="textarea" placeholder="Description du Probleme" style="width: 100%;
                     height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="descprob"></textarea>
                 
                </div>
          <div class="row">
           
            <div class="col-xs-4">
              <input type="submit" class="btn btn-primary btn-block btn-flat" name="ajouter" value="Enregistrer">
            </div><!-- /.col -->
          </div>
        </form>        
