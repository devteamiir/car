...
<section class="content">
          ...
          <div class="error-page">
            <h2 class="headline text-red">STOP</h2>
            <div class="error-content">
              <h3><i class="fa fa-warning text-red"></i> Oops! Vous n'avez pas assez de droits .</h3>
              <p>
                Vous ne pouvez pas visulaliser cette page.
                si vous voulez, vous pouvez retourner vers <a href="<%=request.getContextPath()%>/ClinetControllerAffichage">tableau de bord</a> 
              </p>
